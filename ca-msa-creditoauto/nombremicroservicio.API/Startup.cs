...
namespace nombremicroservicio.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<AutomotrizContext>(options => options.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            #region DEPENDECI INYECTION
            services.AddScoped<ICliente, SrvCliente>();
            services.AddScoped<IEjecutivo, SrvEjecutivo>();
            services.AddScoped<IPatio, SrvPatio>();
            services.AddScoped<IMarca, SrvMarca>();
            services.AddScoped<IAuto, SrvAuto>();
            services.AddScoped<ISolicitud, SrvSolicitud>();
            #endregion DEPENDECI INYECTION
